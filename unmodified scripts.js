try {
	...
	(() => {
		...
		function drawPolygon(ctx, polygonX, polygonY, polygonWidth, polygonHeight) {
			ctx.moveTo(polygonX, polygonY);
			ctx.lineTo(polygonX + polygonWidth, polygonY);
			ctx.lineTo(polygonX + polygonWidth, polygonY + polygonHeight);
			ctx.lineTo(polygonX, polygonY + polygonHeight);
		}
		...
		function changeScreen(newScreen) {
			...
			stageTextEl.hidden = themeNameEl.hidden = fgLayerEl.hidden = gameLayerEl.hidden = flowMeterLayerEl.hidden = timerEl.hidden = screen !== 'game';
		...
		*/
		...
		stages = [
			...
			new Stage(solitaryTheme, [
				...
				ctx.font = arial(9);
				ctx.fillStyle = '#DDD';
				centerText(ctx, 'LEFT/RIGHT OR A/D', 250, 253);
				ctx.fillRect(242, 225, 16, 16);
				ctx.beginPath();
				
				drawPolygon(ctx, 300, 100, 20, 20);
				...
				ctx.beginPath();
				for (let i = 1; i < 3; i++) {
					ctx.moveTo(490, 228 + 4 * i);
					ctx.lineTo(493, 224 + 4 * i);
					ctx.lineTo(496, 228 + 4 * i);
					ctx.lineTo(496, 230 + 4 * i);
					ctx.lineTo(493, 226 + 4 * i);
					ctx.lineTo(490, 230 + 4 * i);
				}
				ctx.fill();
				for (let i = 0; i < 3; i++) {
					ctx.fillStyle = gray(9 + 2 * i);
					ctx.fillRect(625 + 40 * i, 225, 16, 16);
					ctx.beginPath();
					for (let j = 0; j < 4; j++) {
						ctx.moveTo(615 + 40 * i, 228 + 4 * j);
						ctx.lineTo(618 + 40 * i, 224 + 4 * j);
						ctx.lineTo(621 + 40 * i, 228 + 4 * j);
						ctx.lineTo(621 + 40 * i, 230 + 4 * j);
						ctx.lineTo(618 + 40 * i, 226 + 4 * j);
						ctx.lineTo(615 + 40 * i, 230 + 4 * j);
					}
					ctx.fill();
				}
				drawSign(ctx, 830, 220, 110, 40);
				drawSignLight(ctx, 855, 220, 30);
				drawSignLight(ctx, 915, 220, 30);
				ctx.fillStyle = '#AAA';
				ctx.fillRect(907, 225, 16, 5);
				ctx.font = arial(9);
				ctx.fillStyle = '#DDD';
				centerText(ctx, 'DOWN OR S TO SLIDE', 885, 253);
				ctx.fillRect(847, 225, 16, 16);
				ctx.fillRect(907, 233, 16, 8);
				ctx.beginPath();
				ctx.moveTo(873, 232);
				ctx.lineTo(888, 232);
				ctx.lineTo(888, 226);
